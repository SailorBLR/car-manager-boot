 ...
 *
 * $animate.leave(kids[0]); //stagger index.html=0
 * $animate.leave(kids[1]); //stagger index.html=1
 * $animate.leave(kids[2]); //stagger index.html=2
 * $animate.leave(kids[3]); //stagger index.html=3
 * $animate.leave(kids[4]); //stagger index.html=4
 *
 * $timeout(function() {
 *   //stagger has reset itself
 *   $animate.leave(kids[5]); //stagger index.html=0
 *   $animate.leave(kids[6]); //stagger index.html=1
 * }, 100, false);
 * ```
 *
